...
if __name__ == "__main__":
    ...
    likelihood_ratio_test(Validation20KSamples, mu1000, sigma1000, prior1000, './HW3/MLE_TrainedWith_1000_Samples', [weights1000[0], weights1000[1]], "Train with 1000 samples")
